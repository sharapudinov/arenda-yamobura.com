...
<div class="services_section_block">
    ...
    foreach ($arResult["SECTIONS"] as $arItem):?>
        ...
        <? //s($arItem);
        ?>
        <? if ($count % 3 == 0) echo "<div class='three_block'>";
        $count += 1; ?>
        <article class="services_section_item" itemscope itemtype="http://schema.org/Article">
            <a href="<?= $arItem["SECTION_PAGE_URL"]; ?>" class="animation_img">
            ...
            <div class="description">
                <h2>
                    <a rel="bookmark" href="<?= $arItem["SECTION_PAGE_URL"] ?>"
                       itemprop="name"><?= $arItem["NAME"] ?></a>
                </h2>
