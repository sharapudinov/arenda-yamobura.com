...
//test_dump($arResult['PROPERTIES']['SPECIAL_SERVICES']['VALUE']);
...
<div class="projects_top">
    ...
    <div class="projects_info">
        ...
        <? endforeach; ?>
        <span><input type="button" value="Оформить заказ" onclick="yaCounter35589190.reachGoal('forma_services');"/></span>
    </div>
</div>
