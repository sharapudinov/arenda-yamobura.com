...
<?
	...
	?>
	<button id="more_services" data-all-count="<?print_r($data_all_count)?>" data-section-id="<?=$arSection["ID"]?>" data-site-id="<?=SITE_DIR?>"><?=GetMessage("MORE");?></button>
<?	
	}
echo "</div>";
}
