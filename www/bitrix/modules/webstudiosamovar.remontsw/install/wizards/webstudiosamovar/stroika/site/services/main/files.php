...
WizardServices::ReplaceMacrosRecursive(WIZARD_SITE_PATH."calculator/", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
___writeToAreasFile(WIZARD_SITE_PATH."include/header/phone.php", $wizard->GetVar("siteNumber"));
___writeToAreasFile(WIZARD_SITE_PATH."include/footer/phone.php", $wizard->GetVar("siteNumber"));
___writeToAreasFile(WIZARD_SITE_PATH."include/contact/phone.php", $wizard->GetVar("siteNumber"));
___writeToAreasFile(WIZARD_SITE_PATH."include/header/address.php", $wizard->GetVar("siteAddress"));
___writeToAreasFile(WIZARD_SITE_PATH."include/footer/address.php", $wizard->GetVar("siteAddress"));
___writeToAreasFile(WIZARD_SITE_PATH."include/contact/address.php", $wizard->GetVar("siteAddress"));
...
if($siteLogo>0)
{
	...
	if($zr = $ff->Fetch())
	{
		...
		@copy($strOldFile, WIZARD_SITE_PATH."upload/logo.png");
		$pathLogo = trim(WIZARD_SITE_DIR."upload/logo.png");
		___writeToAreasFile(WIZARD_SITE_PATH."include/header/logo.php", '<a href="/"><div style="background: url('.$pathLogo.') no-repeat;"></div></a>');
