...
CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"].BX_PERSONAL_ROOT."/templates/".WIZARD_TEMPLATE_ID."_".WIZARD_THEME_ID."/header.php", array("WIZARD_SITE_ID" => WIZARD_SITE_ID));

CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax_script/sendMail.php", array("LID" => $arSite["LID"]));?>
