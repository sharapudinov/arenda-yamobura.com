...
$projects_element = CIBlockElement::GetList(array(), array("IBLOCK_ID" => "#PRICE_IBLOCK_ID#","ID"=>$arResult["ELEMENTS_LIST"]), false, false,array("ID","NAME","PROPERTY_PRICE", "PROPERTY_SYMBOL"));
$allPrice=0;
