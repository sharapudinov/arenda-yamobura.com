...
$iblockCode = "stroika_portfolio_".WIZARD_SITE_ID; 
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/projects/index.php", array("PORTFOLIO_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/ajax_script/projects.php", array("PORTFOLIO_IBLOCK_ID" => $iblockID));
